...
class SliderAdapter(imageUrl: ArrayList<String>, textTitle: ArrayList<String>, textDesc: ArrayList<String>) :
    ...
    var sliderTitle: ArrayList<String> = textTitle

    var sliderDesc: ArrayList<String> = textDesc
